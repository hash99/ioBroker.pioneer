...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new pioneer name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/pioneer.png')) {
        fs.renameSync(__dirname + '/admin/pioneer.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/pioneer.html')) {
        fs.renameSync(__dirname + '/widgets/pioneer.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/pioneer/js/pioneer.js')) {
        fs.renameSync(__dirname + '/widgets/pioneer/js/pioneer.js', __dirname + '/widgets/pioneer/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/pioneer')) {
        fs.renameSync(__dirname + '/widgets/pioneer',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /pioneer/g,
        ...
        {
            match: /Pioneer/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Pioneer'
        },
        {
